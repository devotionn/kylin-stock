...
const routes = [
  ...
  { path: '/distribution', component: PlaceholderView, meta: { title: '库存物资分布', subtitle: '查看各存放位置的库存分布' } },
  { path: '/ledger', component: PlaceholderView, meta: { title: '出入库明细', subtitle: '按名称、时间、单位和去向查询流水' } },
